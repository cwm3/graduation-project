...
Qa qa  = qadao.listQaClientName(startdate,enddate,vendorid,clientname,lead,field);

//1
String wrongall = Float.valueOf(qa.getWrongcategory())+Float.valueOf(qa.getWrongminor())+Float.valueOf(qa.getWrongpoints())
+ Float.valueOf(qa.getWrongserious())+ Float.valueOf(qa.getWrongweighted())+ Float.valueOf(qa.getWrongcritical())+"";

//2
String meanall = Float.valueOf(qa.getMeaningcategory())+Float.valueOf(qa.getMeaningminor())+Float.valueOf(qa.getMeaningpoints())
+ Float.valueOf(qa.getMeaningserious())+ Float.valueOf(qa.getMeaningweighted())+ Float.valueOf(qa.getMeaningcritical())+"";
...
+ Float.valueOf(qa.getOmissionserious())+ Float.valueOf(qa.getOmissionweighted())+ Float.valueOf(qa.getOmissioncritical())+"";
...
+ Float.valueOf(qa.getStructuralserious())+ Float.valueOf(qa.getStructuralweighted())+Float.valueOf(qa.getStructuralcritical())+"";
...
+ Float.valueOf(qa.getMisspellingserious())+Float.valueOf(qa.getMisspellingweighted())+Float.valueOf(qa.getMiscellaneouscritical())+"";
...
+ Float.valueOf(qa.getPunctuationserious())+ Float.valueOf(qa.getPunctuationweighted())+ Float.valueOf(qa.getPunctuationcritical())+"";

//7
String styleall = Float.valueOf(qa.getStylecategory())+Float.valueOf(qa.getStyleminor())+Float.valueOf(qa.getStylepoints())
+ Float.valueOf(qa.getStyleserious())+ Float.valueOf(qa.getStyleweighted())+Float.valueOf(qa.getStylecritical())+"";
...
+ Float.valueOf(qa.getMiscellaneousserious())+ Float.valueOf(qa.getMiscellaneousweighted())+ Float.valueOf(qa.getMiscellaneouscritical())+"";
...
String allall = Float.valueOf(qa.getWrongcategory())+Float.valueOf(qa.getMeaningcategory())+Float.valueOf(qa.getOmissioncategory())+Float.valueOf(qa.getStructuralcategory())+Float.valueOf(qa.getMisspellingcategory())
                +Float.valueOf(qa.getPunctuationcategory())+Float.valueOf(qa.getStylecategory())+Float.valueOf(qa.getMiscellaneouscategory())+Float.valueOf(qa.getMiscellaneouscritical())+"";
...
String categoryall = Float.valueOf(qa.getWrongcategory())+Float.valueOf(qa.getMeaningcategory())+Float.valueOf(qa.getStructuralcategory())
    +Float.valueOf(qa.getOmissioncategory())+Float.valueOf(qa.getPunctuationcategory())+Float.valueOf(qa.getStylecategory())+Float.valueOf(qa.getMiscellaneouscategory())+"";
...
//66
String criticalall = Float.valueOf(qa.getWrongcritical())+Float.valueOf(qa.getMeaningcritical())+Float.valueOf(qa.getStructuralcritical())+Float.valueOf(qa.getMisspellingcritical())
+Float.valueOf(qa.getPunctuationcritical())+Float.valueOf(qa.getStylecritical())+Float.valueOf(qa.getMiscellaneouscritical())+"";
%>
  ...
  <body style="background:url('images/1.jpg');text-align:center;">
    ...
    <div id="container">
			...
			<table  width="100%" cellspacing="0" cellpadding="0" align="center" >
				...
				<td><%=qa.getStructuralcritical() %></td>				
				...
				<td><%=qa.getMisspellingcritical() %></td>
				...
				<td><%=qa.getPunctuationcritical()  %></td>
				...
				<td><%=qa.getMiscellaneouscritical() %></td>				
