...
<script language="JavaScript" charset="UTF-8"> 
 ...
 function checkpost() {
               ...
               document.getElementById("ContentFrame1").src="selectvendor.action?vendorid="+vendorid+"&vendor_name="+vendorname;
                return false;
		}
</script>
  </head>
    ...
    <legend class="legend">Query Conditions</legend>
      <div class="tijiao">   
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <td><input type="text" id="vendorname"  name="vendorname" class="inputstyle" autocomplete="off"  style="width:200px;height:25px;" ><div id ="vendornameauto"></div></td>
              </tr> 
       </table>
