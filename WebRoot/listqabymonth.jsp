...
List list  = qadao.loadqaByMonth(vendorname,clientname,evaluator,lead,costcode,translationtype,targetlanguage, sourcelanguage,startyear,startmonth,endyear,endmonth,lmorgl,field);
  ...
  <body style="background:url('images/1.jpg');text-align:center;" onload="init()">
   ...
   <div id="container">
		...
		<table  width="100%" cellspacing="0" cellpadding="0" >
				...
				<th colspan="1"  style="text-align:left;" >Vendor Id</th>
				<th colspan="1"  style="text-align:left;" >Vendor Name</th>
				<%
	 	...
	 	<%
			      ...
			      Qa qa =  new Qa();
			      qa=(Qa)list.get(i);
			      String vendorid1= qa.getVendorid();
			      String vendorname1= qa.getVendorname();
			      String score= qa.getScore();
			      out.print("<tr align='left'><td><a href='listqaclientname.jsp?vendorid="+vendorid1+"&startdate="+startdate+"&enddate="+enddate+"&clientname=&lead=&field='>"+vendorid1+"</a></td>");			      
/* 			      out.print("<tr align='left'><td><a href='listqaevaluation.jsp?vendorid="+vendorid1+"&month="+listmonth.get(j)+"'>"+result+"</a></td>");
 */			      
			      out.print("<td>"+vendorname1+"</td>");
			      ...
			      for(int j=0;j<aa.length;j++) {
			        if(aa[j].equals("0")) {
                               ...
                               out.print("<td><a href='listqaevaluation.jsp?vendorid="+vendorid1+"&month="+listmonth.get(j)+"'>"+result+"</a></td>");
