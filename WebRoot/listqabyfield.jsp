...
List list  = qadao.loadqaByField(vendorname,clientname,evaluator,lead,costcode,translationtype,targetlanguage, sourcelanguage,startyear,startmonth,endyear,endmonth,lmorgl,field);
  ...
  <body style="background:url('images/1.jpg');text-align:center;" onload="init()">
   ...
   <div id="container">
		...
		<table  width="100%" cellspacing="0" cellpadding="0" >
				...
				<th colspan="1"  style="text-align:left;" >Field</th>
	 	...
	 	<%
			      ...
			      Qa qa =  new Qa();
			      qa=(Qa)list.get(i);
			      String sector= qa.getSector();

			      
			      String score= qa.getScore();
			      out.print("<tr align='left'><td><a href='listqaclientname.jsp?startdate="+startdate+"&enddate="+enddate+"&field="+sector+"&clientname=&vendorid=&lead='>"+sector+"</a></td>");			      
			      out.print("<td></td>");
