$(document).ready(function(){	
	...
	var timeout;
	var wordInput = $("#clientname");	
	var wordInputOffset = wordInput.offset(); 
	
	var autoNode = $("#clientnameauto");
	...
	wordInput.keyup(function(event)
	{
	    ...
	    {
	    	var textInput = wordInput.val()+",clientname";
	    	...
	    	if(textInput != "" ) 
	    	{
	    		...
	    		timeout = setTimeout(
							function(){
	    			$.post("servlet/ClientNameServlet",{text:textInput},function(data) 
	    			{
	    				
			    		var jqueryObj = $(data);
			    		var wordNodes = jqueryObj.find("clientname");
