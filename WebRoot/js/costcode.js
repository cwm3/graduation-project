$(document).ready(function(){	
	...
	var timeout;
	var wordInput = $("#costcode");
	var wordInputOffset = wordInput.offset(); 
	
	var autoNode = $("#costcodeauto");
			...
			
	{
	    ...
	    {
	    	var textInput = wordInput.val()+",costcode";
	    	
	    	if(textInput != "" ) 
	    	{
	    		clearTimeout(timeout);
	    		timeout = setTimeout(function(){
	    			$.post("servlet/CostCodeServlet",{text:textInput},function(data) 
	    			{
			    		var jqueryObj = $(data);
			    		var wordNodes = jqueryObj.find("costcode");
		    			autoNode.html("");
