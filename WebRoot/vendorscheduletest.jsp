...
<html>
  ...
  <div id="myrl" style="width:80%; margin-left:auto; margin-right:auto; height:1300px; overflow:hidden;">
     <TABLE class="biao" width="100%" id="sucaijiayuan">
        <TBODY>
          <TR>
          <TD class="calTit" colSpan=7 style="height:30px;padding-top:3px;text-align:center;"><a href="<%=basePath%>vendorscheduletest.jsp#" title="last year" id="nianjian" class="ymNaviBtn lsArrow"></a> <a href="<%=basePath%>vendorscheduletest.jsp#" title="last month" id="yuejian" class="ymNaviBtn lArrow"></a><div style="width:250px; float:left; padding-left:230px;"> <span id="dateSelectionRili" class="dateSelectionRili" style="cursor:hand;color: white; border-bottom: 1px solid white;" > <span id="nian" class="topDateFont"></span><span class="topDateFont">-</span><span id="yue" class="topDateFont"></span><span class="topDateFont">&nbsp;</span></span> &nbsp;&nbsp;<font id=GZ class="topDateFont"></font></div>                   <!--新加导航功能-->              
              ...
              <a href="<%=basePath%>vendorscheduletest.jsp#" id="nianjia" title="next year" class="ymNaviBtn rsArrow" style="float:right;"></a> <a href="<%=basePath%>vendorscheduletest.jsp#"  id="yuejia" title="next month" class="ymNaviBtn rArrow" style="float:right;"></a> 
			</TD>
          </TR>
     ...
     <td width="100%" align="center">
      ...
      <table  border="1"  cellpadding="0" cellspacing="0">
          <tr align="left">
            ...
            <td width="270">&nbsp;&nbsp;<input type="button" value="submit" id="submit" class="button6"  onclick="h_submit()" >
   ...
   <div id="bottompage" class="bottompage" >
	   <table cellspacing="0" cellpadding="0" width="100%" height="400px">
		   <tr> 
