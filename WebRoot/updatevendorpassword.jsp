...
<script language="JavaScript"> 
    ...
    function checkuser() {    
        ...
        var vendorpassword = document.getElementById("vendorpassword").value; 
        var newpassword = document.getElementById("newpassword").value; 
        var res=XMLHttpReq.responseXML.getElementsByTagName("RES")[0].firstChild.data;
        if(res=="cz"){
            ifcz="update";
            sendRequest("doupdatevendorpassword.jsp?vendorpassword="+vendorpassword+"&vendorid="+vendorid+"&newpassword="+newpassword);   
        }else {
             alert("Vendor ID or Password is not correct  ");
        }
    }
    ...
    function updateuserpassword() { 
        ...
        if(vendorpassword==""||vendorpassword==null) {
            alert("Password must be inserted ! ");
            return false;
        }
        
        if(newpassword==""||newpassword==null) {
            alert("New Password  must be inserted ! ");
            return false;
        }
        
                
        ifcz="check";
        sendRequest("checkvendorname.jsp?vendorpassword="+vendorpassword+"&vendorid="+vendorid); 
        return false;
    }
...
<table id="travel" >
    ...
    <tbody>
    	<tr >
    		<th colspan="1" scope="row" width="20%" >Vendor ID</th>
            <td colspan="1" > <input id="vendorid" name="vendorid"  type="text" style="width:60%;height:20px;font-size:11px;"  /><span class='redtext'>*</span></td>
        </tr>
        
        <tr>
    		<th colspan="1" scope="row" width="20%" >Password</th>
            <td colspan="1" > <input id="vendorpassword" name="vendorpassword"  type="text"  style="width:60%;height:20px;font-size:11px;" /><span class='redtext'>*</span></td>
        </tr>
