    ...
    <form method="post" action="addcostcode.action" id="myform"  name="myform" onsubmit="return checkpost();" >
      ...
      <div class="tijiao">   
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <td><input type="text" id="costcode"  name="costcode" onblur="checkcostcode()" class="inputstyle"  style="width:180px;height:25px;" ><span class='redtext'>*</span></td>
           
           <td align="right" ><span class='title'>Client Name</span></td>
           <td><input type="text" id="clientname"  name="clientname" style="width:180px;height:25px;" class="inputstyle"  ><span class='redtext'>*</span></td>
           
           <td align="right"><span class='title'>Lead</span></td>
           <td><input type="text" id="lead"  name="lead"  style="width:180px;height:25px;"  class="inputstyle" ><span class='redtext'>*</span></td>
         
            </tr> 
            
             <tr>
             <td align="right" ><span class='title'>Date</span></td>
             <td><input type="text" id="datedate"  name="datedate"   class="inputstyle"   onclick="new Calendar_new(null, null, 1).show(this);" readonly="readonly"  style="width:180px;height:25px;" ><span class='redtext'>*</span></td>
    	...
    	<input type="button" value="Query" onclick="querycostcode()" class="buttonstyle"  style="width:60px;height:25px;font-size: 11px;" />
