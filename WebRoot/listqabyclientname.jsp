...
List list  = qadao.loadqaByClentName(vendorname,clientname,evaluator,lead,costcode,translationtype,targetlanguage, sourcelanguage,startyear,startmonth,endyear,endmonth,lmorgl,field);
  ...
  <body style="background:url('images/1.jpg');text-align:center;" onload="init()">
   ...
   <div id="container">
		...
		<table  width="100%" cellspacing="0" cellpadding="0" >
				...
				<th colspan="1"  style="text-align:left;" >Client Name</th>
				<th colspan="1"  style="text-align:left;" >Client Prefix</th>
	 	...
	 	<%
			      ...
			      Qa qa =  new Qa();
			      qa=(Qa)list.get(i);
			      String clientname1= qa.getClientname();
			      String clientname2= "";
			      if(clientname1!=null){
			        clientname2=clientname1.replace("&", "20180101");
			      }
			      String sdlcostcode1= qa.getSdlcostcode();
			      String score= qa.getScore();
			      out.print("<tr align='left'><td><a href='listqaclientname.jsp?startdate="+startdate+"&enddate="+enddate+"&clientname="+clientname2+"&lead=&field=&vendorid='>"+sdlcostcode1+"</a></td>");			      
			      out.print("<td>"+clientname1+"</td>");
