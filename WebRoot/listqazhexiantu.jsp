...
for(int i=0; i<list.size(); i++ ) {
    ...
    if(vendoridnew!=null) {
        vendoridnew=vendoridnew.replace("&", "20182018").replace(",", "20172017");
    }
    
    String vendornamenew= qa.getVendorname();
    if(vendornamenew != null) {
        vendornamenew=vendornamenew.replace("&", "20182018").replace(",", "20172017");
      }
    
    String clientnamenew =  qa.getClientname();
     if(clientnamenew != null) {
     
         clientnamenew=clientnamenew.replace("&", "20182018").replace(",", "20172017");
     }
     
    String leadnew= qa.getLead();
     if(leadnew != null) {
      leadnew=leadnew.replace("&", "20182018").replace(",", "20172017");
    }
