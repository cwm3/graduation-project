...
public class VendorNameServlet extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    List vendornameall = new ArrayList();
    ...
    for (int i = 0; i < vendors.size(); ++i) {
      ...
      vendornameall.add(vendorname);
    }

    
    request.setAttribute("vendorname", vendornameall);
    request.getRequestDispatcher("/vendornamexml.jsp").forward(request, response);
  }
